...
import { LinkStyled } from '@/containers/home/HomeBlogSection/styled'
...
const ServiceCardsSection = () => (
  <CardsWrapperStyled>
    <CardsContentStyled>
      {iconsData.ServiceCards.map(({ id, title, subtitle, img, link, linkText }) => (
        <CardContainerStyled key={id}>
          <ImgContainerStyled img={img} />
          <TitleStyled>{title}</TitleStyled>
          <Subtitle fontSize='16' lineHeight='28' width='470' text={subtitle} />
