...
export const articles: IArticles[] = [
  {
    ...
    views: 481,
    share: iconsData.ShareSocialIcons,
    tags: [
      {
        id: 1,
        title: 'Data',
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        id: 5,
        type: 'h6',
        text: '“Morbi urna massa, imperdiet in mauris et, euismod vestibulum lacus. Integer enim elit, tincidunt aliquam ligula id, lacinia auctor orci. Sed quis lobortis eros. Fusce id commodo libero. Mauris purus diam, iaculis non leo nec, ultricies fringilla odio. Fusce feugiat elit facilisis volutpat venenatis.”',
        decorate: {
          type: '',
          text: '',
        },
  ...
  },
  {
    ...
    date: '22 June 2020',
    person: 'William Pond',
    title: '2022 information security',
    content: [
      {
        id: 1,
        type: 'p',
